LANSA.addComponent({id:"XGOOGLE01",nm:"xGooglePieChart",ot:"ww",tp:"Widget",de:"Google Pie Chart",tl:14010000},function(l,oI,u){var fF=function(wP){wP.fireItemGotSelection=function(pIndex,pCaption,pValue){var eP=l.ePs();eP.aI("INDEX",pIndex);eP.aS("CAPTION",pCaption);eP.aD("VALUE",pValue);l.fE(this,"ITEMGOTSELECTION",eP);};};var fW=
