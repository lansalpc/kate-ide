...
function( Lansa, objectId, undefined )
{
   ...
   var COM_OWNER = Lansa.registerClass( objectId,
   {
      ...
      co: function()
      {
         ...
         // -- Create Fields --
         // -------------------
         this.addFields( "XSPRDTIL", Fields );
         ...
         LSTOCKSTATUSITEM1.setMarginLeft( 5 );
         ...
         XSPRODUCTPRICEITEM1.setMarginLeft( 5 );
         ...
         LPRODUCTDETAILITEM1.setAlignment( "TOPLEFT" );
         LPRODUCTDETAILITEM1.setMarginRight( 3 );
         ...
         LPRODUCTDESCRIPTION.setWidth( 267 );
