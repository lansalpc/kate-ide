LANSA.addComponent({id:"XCONNEC04",nm:"xConnectorProgramCall",ot:"ww",tp:"Widget",de:"Call a program",tl:14010000},function(l,oI,u){var fF=function(wP){wP.fireProgramCallCompleted=function(pStatus,pError){var eP=l.ePs();eP.aE("STATUS",pStatus);eP.aS("ERROR",pError);l.fE(this,"PROGRAMCALLCOMPLETED",eP);};};var fW=
