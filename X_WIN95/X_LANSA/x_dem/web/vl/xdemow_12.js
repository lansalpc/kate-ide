(function(l,u){var oI=l.cV({id:"XDEMOW_12",nm:"xDemoWebGoogleBarChart",ot:"ww",tp:"Widget",de:"Google Bar Chart",tl:3});var fF=function(wP){wP.fireItemSelected=function(pIndex,pDescription,pValue){var eP=l.ePs();eP.aI("INDEX",pIndex);eP.aS("DESCRIPTION",pDescription);eP.aI("VALUE",pValue);l.fE(this,"ITEMSELECTED",eP);};};var fW=
