(function(l,u){var oI=l.cV({id:"XDEMOW_13",nm:"xDemoWebGooglePieChart",ot:"ww",tp:"Widget",de:"Google Pie Chart",tl:3});var fF=function(wP){wP.fireItemSelected=function(pIndex,pValue,pCaption){var eP=l.ePs();eP.aI("INDEX",pIndex);eP.aI("VALUE",pValue);eP.aS("CAPTION",pCaption);l.fE(this,"ITEMSELECTED",eP);};};var fW=
...
;
l.rWg({nm:"XDEMOW_13",js:["https://www.google.com/jsapi"],fe:fF,fn:fW});var cO=l.rC(oI,{an:"PRIM_WDGT",at:"Control",co:function(){cO.aN.call(this);this.setTITLE("");}});cO.getTITLE=function(){return l.tS(this.get("Title"));};cO.setTITLE=function(v){this.set("Title",l.tS(v));};cO.mthCLEAR=function(){this.invoke("Clear");};cO.mthINSERT=function(P0,P1){return l.tI(this.invoke("Insert",[l.tI(P0),l.tS(P1)]));};cO.mthREMOVE=function(P0){this.invoke("Remove",[l.tI(P0)]);};}(window["LANSA"]));