LANSA.addComponent({id:"XDEVICE07",nm:"xDeviceFileCopy",ot:"ww",tp:"Widget",de:"Copy local files",tl:14010000},function(l,oI,u){var fF=function(wP){wP.fireCompleted=function(pStatus,pMessage){var eP=l.ePs();eP.aE("STATUS",pStatus);eP.aS("MESSAGE",pMessage);l.fE(this,"COMPLETED",eP);};};var fW=
