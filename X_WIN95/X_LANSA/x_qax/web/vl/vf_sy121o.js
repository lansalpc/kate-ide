...
{
var pThis = window.VLFONE.Sessions[s];
if (pThis != null)
{
e = e.toUpperCase();
if (s1 == null) s1 = "";
...
if (pThis != null) pThis.fireSignalEvent(data.e,data.s1,data.s2,data.s3,data.s4);
};
...
PROTOTYPE.Load = function( strFromURL, strRAMPScriptFile, strTheme, strBackgroundColor )
{
var pThis      = this;
...
{
window.alert("A RAMP load failure was detected. The error encountered was - " + oE);
...
};cO.mthUNLOAD=function(){this.invoke("unLoad");};cO.mthLOAD=function(P0,P1,P2,P3){this.invoke("Load",[l.tS(P0),l.tS(P1),l.tS(P2),l.tS(P3)]);};cO.mthCLOSESESSION=function(){this.invoke("CloseSession");};},{rp:["PRIM_WDGT.Control"]});